...
![](https://images.squarespace-cdn.com/content/v1/58d20c79725e25b221549193/1521098258210-W9FBV72SMJJX3LESUA7Z/js.jpg?format=2500ws)

> 项目代码：https://github.com/blazer233/algorithm-learn/tree/main/npm-learn/delay
>
>
...
#### 消除fake-timers影响
在程序运行中，我们有可能会被 `fake-timers`（伪造 `setTimeout`） 所影响，导致 `clearTimeout` 和 `setTimeout` 的使用异常，此时我们可以将定时器的对应方法暴露出去，在 `delay` 上面添加一个新的方法`createWithTimers` 创造一个新的 `delay` ，通过外部传入的方式解决这个问题
